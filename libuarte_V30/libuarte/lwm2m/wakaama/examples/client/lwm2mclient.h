 ...
 * object_temperatur.c
 */
//#define TEMPERATUR_OBJECT_ID 3303
lwm2m_object_t * get_object_temperaturen(void);
void free_temperatur_object(lwm2m_object_t * object);
void display_temperatur_object(lwm2m_object_t * objectP);

/*
 * object_binary.c
 */
//#define TEMPERATUR_OBJECT_ID 3303
lwm2m_object_t * get_object_binary(void);
void free_binary_object(lwm2m_object_t * object);
void display_binary_object(lwm2m_object_t * objectP);
